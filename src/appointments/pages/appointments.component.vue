    ...
    <div class="row flex">
      ...
      <div class="col-10 ">
        <div class="appointment-container">
          ...
          <div class="container-body" v-if="userRole==='vet'">

            <pv-card class="card" v-for="appointment in appointments" v-bind:key="appointment.id" v-show="appointment.veterinarianId===this.currentUser">
              <template #content>
          ...
          <div class="container-body" v-else>
            <pv-card class="card" v-for="appointment in appointments" v-bind:key="appointment.id" v-show="appointment.petOwnerId===this.currentUser">
              <template #content>
                <div class="body-content">
                  <div class="container-body_image">
                    <img
